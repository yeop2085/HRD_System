...
<div id = "Hrd_System_Main">
	<a href = "admin_index">
		<img src = "images/Hrd_System_Main.jpg" width = "1800px" height = "200px">
	</a>
</div>
<div class = "clear"></div>
...
<div id = "top_menu">
	<ul>
		<li>
			<a href = "go_information_ByAdmin" style = "background-color : #B2EBF4">공지사항</a>
			<a href = "information_ByAdmin" style = "font-size : 14px; text-align : right;">바로가기</a>
			...
			<c:forEach items = "${list3Information}" var = "information">
				<tr>
					...
					<td><fmt:formatDate value = "${information.regdate}" type = "date"></fmt:formatDate>
					<td></td>
				</tr>
			</c:forEach>
			</c:when>
		...
		<li>
			<a href = "go_hrd_admin_ByAdmin" style = "background-color : #B2EBF4">인사관리</a>
			<a href = "hrd_information" style = "font-size : 14px; text-align : right;">바로가기</a>
		...
		<li>
			...
			<c:when test = "${empty sessionScope.loginAdmin}">
				...
				<table id = "login">
					<tr>
						<th colspan = "4" style = "background-color : #B2EBF4">관리자 로그인창</th>
					</tr>
					<tr>
						<td style = "background-color : #B2EBF4">ID</td>
						<td colspan = "2"><input type = "text" name = "hrd_admin_id"></td>
						<td><input type = "button" value = "관리자로그인" class = "login_submit" onclick="admin_login()"></td>
					</tr>
					<tr>
						<td style = "background-color : #B2EBF4">PW</td>
						<td colspan = "2"><input type = "password" name = "hrd_admin_pwd"></td>
						<td><input type = "button" value = "로그아웃" class = "login_submit" onclick="admin_logout()"></td>
					</tr>
					<tr>
						<td><input type = "button" value = "회원가입" class = "login_submit" onclick="admin_join()">
						<td><input type = "button" value = "ID/PW찾기" class = "login_submit" onclick="admin_id_pwd_search()"></td>
			...
			<c:otherwise>		
				...
				<table id = "login">
					...
					<tr>
						<td colspan = "4">${sessionScope.loginAdmin.hrd_admin_name} 님이 로그인하셨습니다.</td>
					</tr>
					<tr>
...
<div id = "botton_menu">
	<ul>
		<li>
			<a href = "go_disciplinary_ByAdmin" style = "background-color : #B2EBF4">근태정보</a>
			<a href = "disciplinary_list" style = "font-size : 14px; text-align : right;">바로가기</a>
		...
		<li>
			<a href = "go_salary_ByAdmin" style = "background-color : #B2EBF4">급여정보</a>
			<a href = "salary_list" style = "font-size : 14px; text-align : right;">바로가기</a>
		...
		<li>
			<a href = "chart_ByAdmin" style = "background-color : #B2EBF4">현황</a>
