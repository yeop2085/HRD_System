...
<article>
<form name = "frm" id = "information_view" method = "post">
<h3>게시판 내용</h3>
<fieldset>
	<legend>게시판 내용</legend>
	<label>번호</label>
	<input type = "text" id = "informationView_input" value = "${information.information_number}"> <br>
	<label>제목</label>
	<input type = "text" id = "informationView_input" value = "${informationVO.title}"> <br>
	<label>내용</label>
...
<div id = "buttons">
<input type = "button" value = "돌아가기" class="cancel" onclick="location.href='information'">
</div>
