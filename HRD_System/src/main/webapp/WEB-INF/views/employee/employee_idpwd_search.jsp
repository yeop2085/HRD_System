...
<article>
<form name = "frm" method = "post" action = "employee_idpwd_search">
<h3>사원 ID, PW 찾기</h3>
<table id = "employee_idpwd_search">
	<tr>
...
<div id = "buttons">
	...
	<input type = "button" value = "ID찾기" class = "submit" onclick="employee_id_search()">
	<input type = "button" value = "PW찾기" class = "submit" onclick="employee_pwd_search()">
</div>
