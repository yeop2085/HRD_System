...
<div id = "buttons">
	<input type = "button" value = "나의 정보" class = "submit" onclick="employee_menu()">
	<input type = "button" value = "회원가입" class = "submit" onclick="employee_join()">
	<input type = "button" value = "아이디 비밀번호 찾기" class = "submit" onclick="employee_idpwd_search()">
	<input type = "button" value = "회원탈퇴" class = "submit" onclick="employee_out()">
