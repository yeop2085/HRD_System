...
<article>
<form name = "frm" method = "post" action = "hrd_idpwd_search">
<h3>관리자 ID, PW 찾기</h3>
<table id = "hrd_idpwd_search">
	<tr>
...
<div id = "buttons">
	...
	<input type = "button" value = "ID찾기" class = "submit" onclick="hrd_id_search()">
	<input type = "button" value = "PW찾기" class = "submit" onclick="hrd_pwd_search()">
</div>
